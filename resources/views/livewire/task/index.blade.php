<div class="container-fluid py-2">
    <x-page-header title="Task Registry" subtitle="Manage and track organization-wide action items" :breadcrumbItems="[['label' => 'Tasks', 'url' => '/tasks'], ['label' => 'Registry']]">
        <x-slot name="actions">
            <button class="btn btn-primary px-3 shadow-sm d-flex align-items-center"
    ...
    <div class="card border-0 mb-4" style="background: #fff; border: 1px solid #e2e8f0 !important; border-radius: 8px;">
        <div class="card-body p-3 d-flex flex-wrap gap-2 align-items-center">
            <div class="input-group input-group-sm" style="width: 240px;">
                ...
                <input wire:model.live.debounce.500ms="search" type="text" class="form-control border-start-0"
