                ...
                <div class="col-md-4">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text bg-white border-end-0 text-muted">
                            ...
                            <div class="spinner-border spinner-border-sm text-primary" role="status" wire:loading wire:target="search"></div>
                        </span>
            ...
            <x-table.row wire:key="user-{{ $user->id }}">
                ...
                <x-table.td align="end">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" style="font-size: 0.8125rem; border-radius: 8px;">
                            <li>
