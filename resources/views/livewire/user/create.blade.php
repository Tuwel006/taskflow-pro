            ...
            <form wire:submit.prevent="store">
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold" style="font-size: 0.75rem; color: #64748b;">Full Name (`name`)</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold" style="font-size: 0.75rem; color: #64748b;">Email Address (`email`)</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold" style="font-size: 0.75rem; color: #64748b;">Phone Number (`phone`)</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold" style="font-size: 0.75rem; color: #64748b;">Mailing Address (`address`)</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold" style="font-size: 0.75rem; color: #64748b;">System Role (`role`)</label>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold" style="font-size: 0.75rem; color: #64748b;">User Type (`type`)</label>
